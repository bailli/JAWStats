...
$g_aTranslation[] = array(
    ...
    "translations" => array(
        ...
        "Last updated [DAYNAME], [DATE] [MONTH] [YEAR] at [TIME] [ELAPSEDTIME] " => "Zuletzt aktualisiert [DAYNAME], [DATE] [MONTH] [YEAR] um [TIME] [ELAPSEDTIME]. ",
        "A total of [TOTALVISITS] visits ([UNIQUEVISITORS] unique) this month, an average of [DAILYAVERAGE] per day ([DAILYUNIQUE] unique)." => "Insgesamt [TOTALVISITS] Besuche ([UNIQUEVISITORS] individuelle Besucher) diesen Monat, durchschnittlich [DAILYAVERAGE] ([DAILYUNIQUE]) pro Tag.",
        "March" => "März",
        "May" => "Mai",
        "Monday" => "Montag",
